...
public final class Card implements Comparable<Card> {
   ...
   *
   * @param rank, suit Rank and Suit to assign to the instance fields
  ...
  /**
   * This method returns the suit followed by the numeric value of the card.
   *
  ...
  /**
   * This method returns whether this Card and o are equal. If o is not a Card, the method should
   * return false.
   *
  ...
  /**
   * This method is used for sorting the cards in a player's hand in a game of Poker. Cards are
   * sorted by value.
   *
   * @param other The Card object to which this Card is being compared.
   * @return negative value if this Card should be before the other Card, positive value if this
   *     Card should be after the other Card.
   */
  @Override
